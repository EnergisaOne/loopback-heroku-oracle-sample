...
Thank you for your interest in `loopback-heroku-oracle-sample`, an open source project
administered by StrongLoop.

Contributing to `loopback-heroku-oracle-sample` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-heroku-oracle-sample)
